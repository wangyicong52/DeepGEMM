...
public:
    ...
    static std::string generate_impl(const Args& args) {
        ...
        const bool is_dsv41_decode_target =
        ...
        if (is_dsv41_decode_target and
            get_env<int>("DG_MEGA_MOE_FP4_ROW_PARALLEL_QUANT", 0) != 0)
            source_prefix += "#define DG_MEGA_MOE_FP4_ROW_PARALLEL_QUANT 1\n";
        if (is_dsv41_decode_target and
            get_env<int>("DG_MEGA_MOE_FP4_PHASE_SPECIALIZATION", 0) != 0)
            source_prefix += "#define DG_MEGA_MOE_FP4_PHASE_SPECIALIZATION 1\n";
