...
public:
    ...
    static std::string generate_impl(const Args& args) {
        ...
        const bool use_shared_decode_lut =
            get_env<int>("DG_MEGA_MOE_FP4_SHARED_DECODE_LUT", 0) != 0 and
        ...
        if (use_shared_decode_lut)
            source_prefix += "#define DG_MEGA_MOE_FP4_SHARED_DECODE_LUT 1\n";
